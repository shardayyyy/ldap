...
public class LDAPTest {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapSearchBase = "dc=example,dc=com";  //cn=read-only-admin,dc=example,dc=com

        final String ldapUsername = "riemann"; //"uid=riemann,dc=example,dc=com";
        final String ldapPassword = "password";

        final String ldapAccountToLookup = "tesla4"; //"uid=tesla,dc=example,dc=com";


        Hashtable<String, Object> env = new Hashtable<String, Object>();
        env.put(Context.SECURITY_AUTHENTICATION, "simple");
        env.put(Context.SECURITY_PRINCIPAL, "uid=" + ldapUsername + "," + ldapSearchBase);
        ...
        System.out.println("Details " + getUserDetails(srLdapUser));
    ...
    public SearchResult findAccountByAccountName(DirContext ctx, String ldapSearchBase, String accountName) throws NamingException {
        ...
        //String searchFilter = "(&(objectClass=person)(sAMAccountName=" + accountName + "))";
        String searchFilter = "(&(objectClass=person)(sn=" + accountName + "))";
     ...
     * @throws NamingException
     */
    public static String getUserDetails(SearchResult srLdapUser) throws NamingException {
        if (srLdapUser == null){
            System.out.println("No Details, User Not found");
            return "No Details, User Not found";
        }
        NamingEnumeration namingEnumeration = srLdapUser.getAttributes().getAll();
        StringBuffer stringBuffer = new StringBuffer();
        while(namingEnumeration.hasMoreElements()){
            stringBuffer.append(namingEnumeration.nextElement().toString() + "\n");
        }
